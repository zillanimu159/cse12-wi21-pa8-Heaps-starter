...
/*
 * Write your JUnit tests here Use the formatMaze() method to get nicer JUnit output
 */
...
public class TestSolvers {
    ...
    /*
     * ************** HINT ******************** Use the helper methods to create simple tests that
     * are easier to debug.
     */

    @Test
    public void testshortExample() {
        String[] mazeString = new String[] { "#_#_", "____", "_##S", "F___" };
        int[][] costArray = new int[][] { { 0, 0, 0, 0 }, { 4, 3, 2, 1 }, { 5, 0, 0, 0 },
                { 50, 8, 2, 1 } };

        Maze m = new Maze(mazeString, costArray);
        String[] queueExpected = { "#_#_", "____", "_##S", "F***", };
